...
- **/api/messages**: Manages motorcycle brands and models.
  - `GET /`: Retrieves a list of all brands with their models.
  - `GET /:id`: Retrieves detailed information about a specific brand.
